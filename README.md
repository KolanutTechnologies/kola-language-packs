...
[![Programming targets](https://img.shields.io/badge/Programming%20targets-9-blue)](./packs/coverage-summary.json)
[![Logical tokens](https://img.shields.io/badge/Logical%20tokens-221-lightgrey)](./packs/logical-tokens.json)
...
| **Programming targets** | 9 | +7 | [`packs/coverage-summary.json`](./packs/coverage-summary.json) · [`packs/languages-roadmap.json`](./packs/languages-roadmap.json) |
| **Logical tokens** | 221 | — | [`packs/logical-tokens.json`](./packs/logical-tokens.json) |
